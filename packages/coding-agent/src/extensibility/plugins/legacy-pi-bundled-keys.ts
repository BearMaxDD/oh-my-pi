...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/codex-plan-run",
	...
	"@oh-my-pi/pi-coding-agent/commands/plan-run",
	...
	"@oh-my-pi/pi-coding-agent/commands/superpowers",
	...
	"@oh-my-pi/pi-coding-agent/modes/model-visibility",
	...
	"@oh-my-pi/pi-coding-agent/modes/rpc/rpc-state",
	...
	"@oh-my-pi/pi-coding-agent/task/model-routing",
	...
	"@oh-my-pi/pi-coding-agent/tools/code-write-policy",
	...
	"@oh-my-pi/pi-coding-agent/tools/plan-repair-loop",
