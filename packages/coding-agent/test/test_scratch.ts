...
const ev = {
  ...
  contract_validation: { contract_version: "v2", passed: true, checks: [{ code: "role_exists", passed: true, message: "OK" }] },
  model_binding: { configured_selector: "default", provider: "anthropic", model_id: "claude-sonnet-4-20250514", thinking_source: "explicit", thinking_level: "high", binding_hash: "abc123def456" },
	actual: { exact_match: true as const, fallback_used: false, parent_model_used: false, context_promotion_used: false, provider: "anthropic", model_id: "claude-sonnet-4-20250514", thinking_level: "high", session_created: true, first_dispatch: true },
};
